 ...
 */
package sistema.appweb.controllers;
...
import sistema.accesoadatos.ClienteDAL;
import sistema.entidadesdenegocio.Cliente;
import sistema.appweb.utils.*;
    ...
    private void requestObtenerPorId(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (cliente_result.getId() > 0) {
                ...
                Utilidad.enviarError("El Id:" + cliente.getId() + " no existe en la tabla de Contactos", request, response);
            }
        } catch (Exception ex) {
            Utilidad.enviarError(ex.getMessage(), request, response);
        }
